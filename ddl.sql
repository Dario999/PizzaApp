...
alter table db.orders owner to postgres;
...
alter table db.pizzas owner to postgres;
...
alter table db.ingredients owner to postgres;
...
alter table db.extras owner to postgres;
...
alter table db.ingredients_pizza owner to postgres;
...
alter table db.order_pizza_extras owner to postgres;
